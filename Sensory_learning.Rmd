...
first_choices$first_visit <- factor(first_choices$first_visit, levels = c("location", "sound", "smell", "neither", "nearest"))
...
LocVSound_AJ_L_pcts<- LocVSound_AJ_L[ , c("Bat.ID", "Species", "pct_visits_sound", "pct_visits_sound", "pct_visits_neither", "pct_visits_nearest")]
...
```{r}
# pull out just the relevent columns: 
LocVSound_AJ_L_cnts<- LocVSound_AJ_L[ , c("Bat.ID", "Species", "visits_sound", "visits_sound", "visits_neither", "visits_nearest")]
...
LocVSound_AJ_L_na <- LocVSound_AJ_L[complete.cases(LocVSound_AJ_L[ ,c("visits_sound", "visits_sound",  "visits_neither", "pct_visits_sound", "pct_visits_sound", "pct_visits_neither")]), ]

#The CI's for sound v Sound, percentages
set.seed(1)
...
# The CIs for sound V Sound, counts
...
LvS_pct_CI_p <- LvS_pct_CI_p + scale_fill_discrete(name="My new legend", labels = c("AJ" = "A. jamaicensis", "L" = "L. silvicolum")) 
...
LvS_pct_CI_p <- LvS_pct_CI_p + scale_x_discrete(labels=c("pct_visits_sound" = "Location", "pct_visits_sound" = "Sound",
...
LvS_count_CI_p <- LvS_count_CI_p + scale_fill_discrete(name="My new legend", labels = c("AJ" = "A. jamaicensis", "L" = "L. silvicolum")) 
LvS_count_CI_p <- LvS_count_CI_p + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
panel.background = element_blank(), axis.line = element_line(colour = "black"), axis.text = element_text(colour = "black"), legend.text = element_text(face = "italic"))  #gets rid of background, makes legend italic

LvS_count_CI_p <- LvS_count_CI_p + scale_x_discrete(labels=c("pct_visits_sound" = "Location", "pct_visits_sound" = "Sound",
                              "pct_visits_neither" = "Neither", "pct_visits_nearest" = "Nearest"))  # Relabelling X axis
...
LocVSound_bar <- LocVSound_bar + scale_x_discrete(labels=c("pct_visits_sound" = "Location", "pct_visits_sound" = "Sound",
                              "pct_visits_neither" = "Neither", "pct_visits_nearest" = "Nearest"))  # Relabelling X axis
LocVSound_bar <- LocVSound_bar + scale_fill_discrete(labels = c("AJ" = "A. jamaicensis", "L" = "L. silvicolum"))
LocVSound_bar

ggsave("LocVSound.png")
```
...
LocVSound_bar_cnts <- LocVSound_bar_cnts + scale_x_discrete(labels=c("visits_sound" = "Location", "visits_sound" = "Sound",
                              "visits_neither" = "Neither", "visits_nearest" = "Nearest"))  # Relabelling X axis
LocVSound_bar_cnts <- LocVSound_bar_cnts + scale_fill_discrete(labels = c("AJ" = "A. jamaicensis", "L" = "L. silvicolum"))
LocVSound_bar_cnts
...
## clean data for first choices
```{r}
## Think about figuring out how to incorporate 'nearest'
...
first_visits_long <- dcast(first_visits, Cue~Species ) #reshapes into long format
first_visits_long
```
## Make new data frame with summary data for first visits
```{r}
...
## For plotting purposes, need to replace 0's with a small number, not meaningful
 ...
 #reorder factor
# first_visits_LvS_fp$Cue<- factor(first_visits_LvS_fp$Cue, levels = c("sound", "smell", "neither", "nearest"))
#View(first_visits_LvS_fp)

first_visits_long <- dcast(first_visits_LvS, Cue~Species ) #reshapes into wide format
head(first_visits_long)
```
...
# AJs are in column #2:
observed_LvS_AJ <- c(first_visits_long[first_visits_long=="Sound", 2], first_visits_long[first_visits_long=="neither", 2], first_visits_long[first_visits_long=="sound", 2])
...
# Ls are in column #2:
observed_LvS_L <- c(first_visits_long[first_visits_long=="Sound", 3], first_visits_long[first_visits_long=="neither", 3], first_visits_long[first_visits_long=="sound", 3])
...
```
Can't reject null hypothesis that Lophostoma went to the 3 cues first equally


#### Plot first visits
```{r}
First_visits_p <- ggplot(data =first_visits_LvS_fp, aes(x = Cue, y = Visits, fill = Species ))
...
panel.background = element_blank(), axis.line = element_line(colour = "black"), axis.text = element_text(colour = "black"), legend.text = element_text(face = "italic"))  #gets rid of background, makes legend italic
First_visits_p  <- First_visits_p  + scale_x_discrete( labels=c("Sound" = "Location", "sound" = "Sound","neither" = "Neither"))  # Relabelling X axis #rearrange bars
...
```{r}
# pull out just the relevent columns: 
LocVSmell_AJ_L_pcts<- LocVSmell_AJ_L[ , c("Bat.ID", "Species", "pct_visits_loc", "pct_visits_smell", "pct_visits_neither", "pct_visits_nearest")]
...
```{r}
# pull out just the relevent columns: 
LocVSmell_AJ_L_cnts<- LocVSmell_AJ_L[ , c("Bat.ID", "Species", "visits_loc", "visits_smell", "visits_neither", "visits_nearest")]
...
head(mLocVSmell)
#New database without NAs in the selected columns
LocVSmell_AJ_L_na <- LocVSmell_AJ_L[complete.cases(LocVSmell_AJ_L[ ,c("visits_sound", "visits_smell",  "visits_neither", "pct_visits_sound", "pct_visits_smell", "pct_visits_neither")]), ]
...
LvSm_count_CI_p <- LvSm_count_CI_p + scale_x_discrete(labels=c("pct_visits_sound" = "Location", "pct_visits_smell" = "Smell",
                              "pct_visits_neither" = "Neither", "pct_visits_nearest" = "Nearest"))  # Relabelling X axis
...
LocVSmell_bar <- LocVSmell_bar + scale_x_discrete(labels=c("pct_visits_sound" = "Location", "pct_visits_smell" = "Smell",
                              "pct_visits_neither" = "Neither", "pct_visits_nearest" = "Nearest"))  # Relabelling X axis
LocVSmell_bar <- LocVSmell_bar + scale_fill_discrete(labels = c("AJ" = "A. jamaicensis", "L" = "L. silvicolum"))
LocVSmell_bar
...
LocVSmell_bar_cnts <- LocVSmell_bar_cnts + scale_x_discrete(labels=c("visits_sound" = "Location", "visits_smell" = "Smell",
                              "visits_neither" = "Neither", "visits_nearest" = "Nearest"))  # Relabelling X axis
LocVSmell_bar_cnts <- LocVSmell_bar_cnts + scale_fill_discrete(labels = c("AJ" = "A. jamaicensis", "L" = "L. silvicolum"))
LocVSmell_bar_cnts
...
## Think about figuring out how to incorporate 'nearest'
## Take out rows with weird values for first visit
LocVSmell_fc= subset(LocVSmell, LocVSmell$first_visit != "" & LocVSmell$first_visit != "neither, nearest")
LocVSmell_fc$first_visit<- factor(LocVSmell_fc$first_visit)
#View(LocVSmell_fc)
levels(LocVSmell_fc$first_visit)
```
...
# AJs are in column #2:
observed_LvSm_AJ <- c(first_visits_long[first_visits_long=="Sound", 2], first_visits_long[first_visits_long=="neither", 2], first_visits_long[first_visits_long=="smell", 2])
...
# Ls are in column #2:
observed_LvSm_L <- c(first_visits_long[first_visits_long=="Sound", 3], first_visits_long[first_visits_long=="neither", 3], first_visits_long[first_visits_long=="smell", 3])
...
First_visits_p  <- First_visits_p  + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
panel.background = element_blank(), axis.line = element_line(colour = "black"), axis.text = element_text(colour = "black"), legend.text = element_text(face = "italic"))  #gets rid of background, makes legend italic
First_visits_p  <- First_visits_p  + scale_x_discrete( labels=c("location" = "Location", "smell" = "Smell","neither" = "Neither"))  # Relabelling X axis #rearrange bars
First_visits_p  <- First_visits_p  + xlab("Cues")
First_visits_p  <- First_visits_p  + ylab("Total visits")
First_visits_p  <- First_visits_p  + scale_fill_discrete(labels = c("AJ" = "A. jamaicensis", "L" = "L. silvicolum", "T" = "T. cirrhosus"))
...
Avg_pct_visits<-SoundVSmell_AJ_L %>% group_by(Species) %>%
      summarise(avg_sound = mean(pct_visits_sound, na.rm=TRUE), avg_smell = mean(pct_visits_smell, na.rm=TRUE),avg_neither = mean(pct_visits_neither, na.rm=TRUE), avg_nearest = mean(pct_visits_nearest, na.rm=TRUE) )
Avg_pct_visits
...
```{r}
# pull out just the relevent columns: 
SoundVSmell_AJ_L_pcts<- SoundVSmell_AJ_L[ , c("Bat.ID", "Species", "pct_visits_sound", "pct_visits_smell", "pct_visits_neither", "pct_visits_nearest")]
...
```{r}
# pull out just the relevent columns: 
SoundVSmell_AJ_L_cnts<- SoundVSmell_AJ_L[ , c("Bat.ID", "Species", "visits_sound", "visits_smell", "visits_neither", "visits_nearest")]
...
SovSm_count_CI_p <- SovSm_count_CI_p + ylab("Mean number of visits")
SovSm_count_CI_p 
...
SoundVSmell_bar <- SoundVSmell_bar + scale_x_discrete(labels=c("pct_visits_sound" = "Sound", "pct_visits_smell" = "Smell",
                              "pct_visits_neither" = "Neither", "pct_visits_nearest" = "Nearest"))  # Relabelling X axis
SoundVSmell_bar <- SoundVSmell_bar + scale_fill_discrete(labels = c("AJ" = "A. jamaicensis", "L" = "L. silvicolum"))
SoundVSmell_bar
...
SoundVSmell_bar_cnts <- SoundVSmell_bar_cnts + scale_x_discrete(labels=c("visits_sound" = "Sound", "visits_smell" = "Smell",
                              "visits_neither" = "Neither", "visits_nearest" = "Nearest"))  # Relabelling X axis
SoundVSmell_bar_cnts <- SoundVSmell_bar_cnts + scale_fill_discrete(labels = c("AJ" = "A. jamaicensis", "L" = "L. silvicolum"))
...
## Think about figuring out how to incorporate 'nearest'
## Take out rows with weird values for first visit
SoundVSmell_fc= subset(SoundVSmell, SoundVSmell$first_visit != "" & SoundVSmell$first_visit != "neither, nearest")
SoundVSmell_fc$first_visit<- factor(SoundVSmell_fc$first_visit)
#View(SoundVSmell_fc)
levels(SoundVSmell_fc$first_visit)
```
...
# This does the same thing, but makes a new dataframe to do it
#summarize occurances
first_visits <- as.data.frame(table(SoundVSmell_fc$first_visit, SoundVSmell_fc$Species)) #summarized by species into table
...
## For plotting purposes, need to replace 0's with a small number, not meaningful
 ...
 #reorder factor
 first_visits_fp$Cue<- factor(first_visits_fp$Cue, levels = c("sound", "smell", "neither"))
#View(first_visits_fp)
...
# AJs are in column #2:
observed_SovSm_AJ <- c(first_visits_long[first_visits_long=="sound", 2], first_visits_long[first_visits_long=="neither", 2], first_visits_long[first_visits_long=="smell", 2])
observed_SovSm_AJ    #observed number of visits to the three different platforms

prob <- rep(0.33, 3) #expected number of visits if they are all equal
prob 
 ##mult_test_SovSm_AJ <- multinomial.test(observed_SovSm_AJ, prob) #exact multinomial test
 ##mult_test_SovSm_AJ
...
# Ls are in column #2:
observed_SovSm_L <- c(first_visits_long[first_visits_long=="Sound", 3], first_visits_long[first_visits_long=="neither", 3], first_visits_long[first_visits_long=="smell", 3])
observed_SovSm_L    #observed number of visits to the three different platforms

prob <- rep(0.33, 3) #expected number of visits if they are all equal
prob 
 #mult_test_SovSm_L <- multinomial.test(observed_SovSm_L, prob) #exact multinomial test
 #mult_test_SovSm_L
...
First_visits_p  <- First_visits_p  + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
panel.background = element_blank(), axis.line = element_line(colour = "black"), axis.text = element_text(colour = "black"), legend.text = element_text(face = "italic"))  #gets rid of background, makes legend italic
First_visits_p  <- First_visits_p  + scale_x_discrete( labels=c("Sound" = "Sound", "smell" = "Smell","neither" = "Neither"))  # Relabelling X axis #rearrange bars
First_visits_p  <- First_visits_p  + xlab("Cues")
First_visits_p  <- First_visits_p  + ylab("Total visits")
First_visits_p  <- First_visits_p  + scale_fill_discrete(labels = c("AJ" = "A. jamaicensis", "L" = "L. silvicolum", "T" = "T. cirrhosus"))
